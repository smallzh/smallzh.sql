# AGENTS.md - smallzh.sql 项目指南

## 项目概述

这是一个记录了sql的关键知识的文档项目，使用 MkDocs 构建。项目目标是记录sql的理解和学习笔记，涵盖从基础语法到常用函数的各个方面，主要用于mysql8、postgresql13+版本的测试。
